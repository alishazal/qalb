"""
Usage: python3 sourcePreprocessNoSpaces.py [raw.arabizi] [preprocessed.arabizi] [preprocessed.hash]
Example: python3 sourcePreprocessNoSpaces.py source/bolt-ldc-source-no-dev-test.arabizi source/bolt-ldc-source-preprocessed.arabizi
